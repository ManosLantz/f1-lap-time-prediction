...
def fun_test_verstappen():
    print("🏎️ VERSTAPPEN FUN TEST (Model v3 + Driver_VER)...")
    ...
    # Using the Optimized v3 Params
    XGB_PARAMS = {
        'n_estimators': 455, 
        'max_depth': 4, 
        'learning_rate': 0.010043059237814973, 
        'subsample': 0.7550008688074691, 
        'colsample_bytree': 0.8013679911881985, 
        'reg_alpha': 2.6072823301040744, 
        'reg_lambda': 0.02393727977220944,
    ...
    print("\n" + "="*50)
    print(f"🏆 VERSTAPPEN TEST RESULT")
    print(f"   Avg MAE: {avg_mae:.4f} s")
    print("="*50)
    print(f"   Compare to v3 Optimized (No Drivers): 0.4082 s")
